/*Type definitions for Survey JavaScript library v1.0.13
...
export declare class VueSurveyWindowModel extends SurveyWindowModel {
    constructor(jsonObj: any, initialModel?: SurveyModel);
    protected createSurvey(jsonObj: any): SurveyModel;
}

export declare class Survey extends Vue {
    survey: SurveyModel;
    forceUpdate(): void;
    constructor();
    mounted(): void;
    ...
    getCompletedPageClasses(): string;
...
export declare class CustomWidget extends Vue {
    css: any;
    question: Question;
    readonly hasDefaultRender: boolean;
    readonly hasHtml: boolean;
    readonly customHtml: string;
    readonly hasVueComponent: boolean;
...
export declare class SurveyElementVue extends Vue {
    ...
    getQuestionClass(element: Question): any;
...
export declare class Window extends Vue {
    ...
    constructor();
    readonly windowSurvey: SurveyModel;
    readonly css: any;
    readonly expandedCss: any;
    readonly isExpandedSurvey: boolean;
    doExpand(): void;
}
...
export declare class MultipleText extends QuestionVue<QuestionMultipleTextModel> {
    change(item: any, event: any): void;
}
...
export declare class Row extends Vue {
    ...
    css: any;
    survey: SurveyModel;
    readonly questionRootClass: any;
}
...
export declare class Helpers {
    ...
    static isArraysEqual(x: any, y: any): boolean;
...
export declare class QuestionVue<T extends Question> extends Vue {
    innerValue: any;
    question: T;
    css: any;
